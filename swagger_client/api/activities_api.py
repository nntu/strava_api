...
class ActivitiesApi(object):
    ...
    def create_activity(self, name, type, sport_type, start_date_local, elapsed_time, description, distance, trainer, commute, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_activity(name, type, sport_type, start_date_local, elapsed_time, description, distance, trainer, commute, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: (required)
        :param str type: (required)
        :param str sport_type: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_activity_with_http_info(name, type, sport_type, start_date_local, elapsed_time, description, distance, trainer, commute, **kwargs)  # noqa: E501
        else:
            (data) = self.create_activity_with_http_info(name, type, sport_type, start_date_local, elapsed_time, description, distance, trainer, commute, **kwargs)  # noqa: E501
            return data

    def create_activity_with_http_info(self, name, type, sport_type, start_date_local, elapsed_time, description, distance, trainer, commute, **kwargs):  # noqa: E501
        """Create an Activity  # noqa: E501

        Creates a manual activity for an athlete, requires activity:write scope.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_activity_with_http_info(name, type, sport_type, start_date_local, elapsed_time, description, distance, trainer, commute, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['name', 'type', 'sport_type', 'start_date_local', 'elapsed_time', 'description', 'distance', 'trainer', 'commute']  # noqa: E501
